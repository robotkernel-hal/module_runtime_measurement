...
class MainProject(ConanFile):
    name = "module_runtime_measurement_ln_msgdef"
    url = "https://rmc-github.robotic.dlr.de/robotkernel/module_runtime_measurement"
    author = "Robert Burger robert.burger@dlr.de"
    license = "GPLv3"
    description = "module_runtime_measurement ln message definitions"
    settings = None
    exports_sources = [
        "*",
    ]
    ...
    def package(self):
        ...
        with chdir(self, self.build_folder):
            for dirpath, dirnames, filenames in os.walk("module_runtime_measurement"):
